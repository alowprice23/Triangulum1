    ...
    if os.path.exists(folder_debugger):
        ...
        if "            # Add to debug results" in content:
            ...
            if result["success"] and "Bug successfully fixed" in output:
                # Extract original and fixed content from the output
                try:
                    ...
                    if log_files:
                        ...
                        if "Original Code:" in log_content and "Fixed Code:" in log_content:
                            original_start = log_content.find("Original Code:") + len("Original Code:")
                            fixe
