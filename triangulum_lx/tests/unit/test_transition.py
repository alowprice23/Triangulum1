...
class TestTransition(unittest.TestCase):
    ...
    def test_wait_stays_waiting(self):
    ...
    def test_timer_countdown(self):
        ...
        for phase in [Phase.REPRO, Phase.PATCH, Phase.VERIFY]:
            ...
            new_bug, delta = step(bug, 0)  # Free agents irrelevant here
